...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/wzc/桌面/catkin_ws/src/test)
  set(test_DEVEL_PREFIX /home/wzc/桌面/catkin_ws/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/wzc/桌面/catkin_ws/install)
...
if(NOT "/home/wzc/桌面/catkin_ws/devel/include " STREQUAL " ")
  set(test_INCLUDE_DIRS "")
  set(_include_dirs "/home/wzc/桌面/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'wzc <2532727914@qq.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wzc/桌面/catkin_ws/src/test/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/wzc/桌面/catkin_ws/devel/lib;/opt/ros/melodic/lib)
